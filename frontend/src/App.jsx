  ...
  const handleDebug = async () => {
    ...
    try {
      ...
      if (activeTab === "paste") {
        ...
        const res = await fetch(`${API_BASE}/api/debug`, { method: "POST", headers: authHeaders, body: JSON.stringify({ code, language }) });
...
<div class="footer">Generated by Coding Assistant · Powered by Groq AI</div>
  ...
  return (
    <div className={`app ${showHistory ? 'sidebar-is-open' : ''}`}>
      <DebugHistory
        userId={userId}
        isOpen={showHistory}
